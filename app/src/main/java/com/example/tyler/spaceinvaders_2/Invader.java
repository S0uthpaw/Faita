...
public class Invader {
    ...
    // How long and tall our invader will be
    ...
    public Invader(Context context, int row, int column, int screenX, int screenY) {
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invaderUp);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invaderDown);
    ...
    public void update(long fps){
        ...
        // Update rect - used to detect hits
        rect.top = y;
